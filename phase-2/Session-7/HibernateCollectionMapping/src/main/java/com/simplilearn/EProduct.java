...
public class EProduct {
	...
	private List<Color> colors; ///color mapped with list
	private Collection<ScreenSizes> screenSizes;//Maped with collection
	private Set<OS>os; //mapped with set
	private Map finance; //mapped with map
